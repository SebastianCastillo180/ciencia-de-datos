...
file_path = r'D:\Rayogas\Sistemas de Informacion - Estrategia de Datos\7. Fuentes de Informacion\Xls\Mantenimiento\Recorrido CloudFleet.xlsx'
...
try:
    ...
    # 4. Insertar datos
    table_name = 'Kilometraje_CloudFleet'
