...
conexionString ='DRIVER={SQL Server};SERVER=;DATABASE=DataStage;;PWD='
...
Variables = pd.read_excel(r"C:\Users\analistabi\Downloads\GLP.xlsx") 
...
# Creamos la tabla 
cursor.execute("CREATE TABLE CiudadesPruebasV2(Ciudad VARCHAR(255) NOT NULL, Pais VARCHAR(100) NOT NULL, PRIMARY KEY (Ciudad))")
